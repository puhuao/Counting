 ...
 * @
 */
public class MarketingPopupWindow extends PopupWindow {
    ...
    public MarketingPopupWindow(Activity context,
        ...
        group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                MarketingTransPagerEvent event = new MarketingTransPagerEvent();
