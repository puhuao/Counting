        ...
        if (isNeedDial) {
            ...
            for (int i = 0; i < 40; i++) {
                ...
                if (i % 5 == 0) {
                    ...
                    degreePaint.setColor(Color.parseColor(longDegreeColor));
                    canvas.drawLine(centerX, centerY - diameter / 4 - progressWidth / 2 - DEGREE_PROGRESS_DISTANCE,
                    ...
                    canvas.drawLine(centerX, centerY - diameter / 4 - progressWidth / 2 - DEGREE_PROGRESS_DISTANCE - (longdegree - shortdegree) / 2,
