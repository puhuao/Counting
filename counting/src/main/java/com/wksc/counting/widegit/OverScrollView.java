...
public class OverScrollView extends FrameLayout implements OnTouchListener {
    ...
    @Override
    protected void onScrollChanged(int leftOfVisibleView,
                                   int topOfVisibleView,
                                   int oldLeftOfVisibleView,
        ...
        super.onScrollChanged(leftOfVisibleView,
                              topOfVisibleView,
    ...
    private boolean isViewDescendantOf(View child, View parent) {
        ...
        return (theParent instanceof ViewGroup) && isViewDescendantOf((View) theParent,
                                                                      parent);
    }
    ...
    public void fling(int velocityY) {
        if (getChildCount() > 0) {
            ...
            if (newFocused != findFocus() && newFocused.requestFocus(movingDown ? View.FOCUS_DOWN
                                                                               : View.FOCUS_UP)) {
                mScrollViewMovedFocus = true;
                mScrollViewMovedFocus = false;
            }
