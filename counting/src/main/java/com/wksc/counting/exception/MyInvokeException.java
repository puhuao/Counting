 ...
 * @author wanglin
 */
public class MyInvokeException extends MyException {
    ...
    private MyInvokeException(){
        super();
    }
    @SuppressWarnings("unused")
    private MyInvokeException(Throwable t){
        super(t);
    }
    
    public MyInvokeException(int code, String msg){
        super(msg);
        
        this.code = code;
    }
    
    public MyInvokeException(int code, String msg, Throwable t){
        super(msg,t);
