...
import com.wksc.counting.model.VipNormalModel;
 ...
 */
public class VipNormalCustomerListAdapter extends BaseListAdapter<VipNormalModel>{
    public VipNormalCustomerListAdapter(Activity context) {
        super(context);
        setList(VipNormalModel.getData());
    }
