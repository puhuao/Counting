...
import com.wksc.counting.model.SaveModel;
 ...
 */
public class SaveAnalysisListAdapter extends BaseListAdapter<SaveModel>{
    public SaveAnalysisListAdapter(Activity context) {
        super(context);
        setList(SaveModel.getData());
    }
