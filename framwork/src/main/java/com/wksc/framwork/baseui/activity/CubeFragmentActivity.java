...
import com.wksc.framwork.baseui.FragmentParam;
...
public abstract class CubeFragmentActivity extends FragmentActivity {
    ...
    public void pushFragmentToBackStack(Class<?> cls, Object data) {
        ...
        param.cls = cls;
        param.data = data;
        goToThisFragment(param,true);
    }

    public void pushFragmentToBackStackNoAnim(Class<?> cls, Object data) {
        FragmentParam param = new FragmentParam();
        param.cls = cls;
        param.data = data;
        goToThisFragment(param,false);
    }
    ...
    private void goToThisFragment(FragmentParam param,boolean isAnim) {
        ...
        try {
            ...
            if(isAnim){
                ft.setCustomAnimations(R.anim.slide_in_from_left, R.anim.slide_in_from_right,
    ...
    /**
     * fragment use this method go back
     *
